...
namespace HVO.Core.SourceGenerators;

/// <summary>
/// Incremental source generator that generates partial class implementations for types
/// decorated with <c>[NamedOneOf]</c>. Generates Is/As properties, implicit operators,
/// IOneOf interface implementation, and a System.Text.Json converter.
/// </summary>
[Generator]
public class NamedOneOfGenerator : IIncrementalGenerator
{
    private const string AttributeFullName = "HVO.Core.OneOf.NamedOneOfAttribute";
    ...
    private static string GenerateOneOfClass(string className, string namespaceName, (string Name, string TypeName)[] cases)
    {
        ...
        sb.AppendLine($"{indent}public partial class {className} : global::HVO.Core.OneOf.IOneOf");
